...
def principal (request):
    if request.user.is_authenticated:
        ...
        employees = Employee.objects.all().order_by('name')[:4]
        emp_lenght = employees.count()
        prod_lenght = products.count()
        return render(request, 'index.html', { 'products':products , 'empl':employees, 'elenght':emp_lenght, 'plenght':prod_lenght})
